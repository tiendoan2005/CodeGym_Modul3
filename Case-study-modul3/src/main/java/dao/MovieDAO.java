...
public class MovieDAO implements GeneralDAO<Movie> {
    ...
    private static final String SEARCH_MOVIE_BY_TITLE = "SELECT * FROM movies WHERE title LIKE ?";
    ...
    public List<Movie> findByTitle(String keyword) {
        ...
        try (Connection connection = DBConnection.getConnection();
             PreparedStatement statement = connection.prepareStatement(SEARCH_MOVIE_BY_TITLE)) {
